 ...
 */
@WebFilter(filterName = "AuthorizationFilter", urlPatterns = {"/search.jsp"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
